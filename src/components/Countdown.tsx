...
/**
 * Wedding moment the countdown runs to: the start of the wedding day, 00:00 in
 * Los Angeles. The -07:00 offset is LA's PDT — on Oct 10, 2026 the US is still
 * on daylight saving (it ends Nov 1, 2026), so LA is UTC-7. This is one fixed
 * instant, so the countdown is correct for every viewer's timezone.
 */
